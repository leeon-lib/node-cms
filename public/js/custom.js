...
jQuery(document).ready(function() {
   ...
   jQuery('.nav-parent > a').click(function() {
      ...
      jQuery(this).removeClass('nav-activedefault');
   ...
   jQuery('.nav-bracket > li').hover(function(){
      var dis=jQuery(this).find("ul").css("display");
      if(dis=='block'){
         jQuery(this).addClass('nav-hoverdefalut');
      }else{
   ...
   jQuery('.menutoggle').click(function(){
      ...
      if(bodypos != 'relative') {
         ...
         if(!body.hasClass('leftpanel-collapsed')) {
            ...
            //jQuery('.nav-bracket li ul').css({display: 'block'});
            $.cookie("menutoggle","");
